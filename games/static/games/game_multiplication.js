...
function loadMultiplicationView() {
  // TODO
  const view = document.querySelector('#activities-multiplication-view');
  view.innerHTML = 'Hello world!';

  // Set game = addition
  const game = document.createElement('div');
  game.innerHTML = 'Game set to Multiplication!';
  view.append(game);
