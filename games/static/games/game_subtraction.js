...
function loadSubtractionView() {
  // TODO
  const view = document.querySelector('#activities-subtraction-view');
  view.innerHTML = 'Hello world!';

  // Set game = addition
  const game = document.createElement('div');
  game.innerHTML = 'Game set to Subtraction!';
  view.append(game);
